...
public class DetalheVotacaoSecao {
	protected Situacao situacao;
	
	protected String codigoMunicipio;
	protected String nomeMunicipio;
	protected String numeroZona;
	protected String numeroSecao;
	protected Cargo cargo;
	protected String qtdAptos;
	protected String qtdComparecimento;
	protected String qtdAbstencoes;
	protected String qtVotosNominais;
	protected String qtVotosBrancos;
	protected String qtVotosNulos;
	protected String qtVotosLegenda;
	protected String qtVotosAnuladosApuSep;
}