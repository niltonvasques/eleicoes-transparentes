...
@CVSClass(notation = "DespesasComites", headerInFile = true)
public class DespesasComites extends CVSFile {
	@CVSAttr(name = "Data e hora")
	public String dataEHora;
	@CVSAttr(name = "Sequencial Comite")
	public String sequencialComite;
	@CVSAttr(name = "UF")
	public String UF;
