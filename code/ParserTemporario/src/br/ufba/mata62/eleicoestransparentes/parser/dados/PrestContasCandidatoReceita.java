...
public class PrestContasCandidatoReceita {
	@Name("Data e hora")
	...
	@Name("Numero Recibo Eleitoral")
	private String numeroReciboEleitoral;
	...
	public String getNumeroReciboEleitoral() {
		return numeroReciboEleitoral;
	}
	public void setNumeroReciboEleitoral(String numeroReciboEleitoral) {
		this.numeroReciboEleitoral = numeroReciboEleitoral;
	}
